...
def _task_dict(t: Task) -> Dict[str, Any]:
    return {
        ...
        "actual_end": _dt(t.actual_end), "awaits_cook": t.awaits_cook, "pan": t.pan,
    }
...
def _task(d: Dict[str, Any]) -> Task:
    return Task(
        ...
        actual_end=_parse_dt(d.get("actual_end")), awaits_cook=d.get("awaits_cook", False), pan=d.get("pan"),
    )
